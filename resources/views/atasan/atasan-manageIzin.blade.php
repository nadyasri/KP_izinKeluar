            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="py-3 px-3 text-center">
                        <button type="button" onclick="window.location='{{ route('atasan-formVerif', ['id_izin' => $i->id_izin]) }}'" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded"> Lihat Pengajuan </button>
                        <button type="button" onclick="window.location='{{ route('generate.pdf', ['id_izin' => $i->id_izin]) }}'" class="bg-red-500 text-white py-2 px-2 rounded font-bold"> Download Surat </button> 
                    </td>
                </tr>
                @endforeach
            </tbody>
