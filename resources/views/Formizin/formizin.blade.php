    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-grow bg-green-700">
            <div class="bg-white p-10 rounded-tl-3xl rounded-bl-3xl shadow-xl min-h-full">
                ...
                <form action="/submitform" method="POST" class="bg-gray-100 p-6 rounded-lg shadow-md">
                    @csrf
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="bg-green-700 text-white px-4 py-2 rounded-md shadow-md hover:bg-green-800">Kirim</button>
