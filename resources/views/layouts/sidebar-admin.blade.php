...
<div class="bg-green-700 text-white w-64 min-h-screen flex flex-col p-4">
    <div class="text-white flex flex-col items-center">
        ...
        <div class="relative">
            <img src="{{ asset('profile/default-admin.jpg') }}" alt="Foto Profil" class="p-2 rounded-full w-32 h-32 flex">
    ...
    <nav class="mt-6 flex-grow">
        <ul>
            <li class="mb-2 text-amber-50">
                <a href="{{ route('admin-dashboard')}}" class="font-bold text-amber-100 block py-2.5 px-4 rounded transition duration-200 hover:bg-black">Dashboard</a>
            </li>
            <li class="mb-2">
